...
public:
  ...
  bool
  processFrame(const common::http2::frame_base &frame); // true if is handled
  ...
  static IStream *createStream(const common::net::socket_info &info,
                               const common::http2::frame_base &frame);

protected:
  IStream(const common::net::socket_info &info,
          const common::http2::frame_base &frame);
...
public:
  HTTP2DataStream(const common::net::socket_info &info,
                  const common::http2::frame_base &frame);

private:
  virtual bool
  processFrameImpl(const common::http2::frame_base &frame) override;
};
...
public:
  HTTP2PriorityStream(const common::net::socket_info &info,
                      const common::http2::frame_base &frame);
  ~HTTP2PriorityStream();
...
public:
  HTTP2SettingsStream(const common::net::socket_info &info,
                      const common::http2::frame_base &frame);
...
public:
  HTTP2HeadersStream(const common::net::socket_info &info,
                     const common::http2::frame_base &frame);
