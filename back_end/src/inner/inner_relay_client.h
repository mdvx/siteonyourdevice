...
class RelayClient : public http::Http2Client {
 public:
  RelayClient(common::libev::IoLoop* server, const common::net::socket_info& info);
  const char* ClassName() const override;
};

class ProxyRelayClient;

class RelayClientEx : public RelayClient {
 public:
  RelayClientEx(common::libev::IoLoop* server,
...
class ProxyRelayClient : public common::libev::tcp::TcpClient {
 public:
  ProxyRelayClient(common::libev::IoLoop* server, const common::net::socket_info& info, RelayClientEx* relay);
