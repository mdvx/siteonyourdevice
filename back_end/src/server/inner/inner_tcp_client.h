...
class IInnerRelayLoop : public ILoopThreadController {
 public:
  typedef std::pair<common::libev::tcp::TcpClient*, common::buffer_t> request_t;
...
class InnerTcpServerClient : public siteonyourdevice::inner::InnerClient {
 public:
  ...
  InnerTcpServerClient(common::libev::IoLoop* server, const common::net::socket_info& info);
