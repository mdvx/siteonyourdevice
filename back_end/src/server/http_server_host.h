...
class HttpServerHost {
 public:
  ...
  bool unRegisterInnerConnectionByHost(common::libev::IoClient* connection) WARN_UNUSED_RESULT;
  bool registerInnerConnectionByUser(const UserAuthInfo& user, common::libev::IoClient* connection) WARN_UNUSED_RESULT;
