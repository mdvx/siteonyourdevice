...
namespace
{
    ...
    {
        fasto::fastoremote::redis_sub_configuration_t redis_config_;
    };
...
fasto::fastoremote::HttpServerHost* server = NULL;
fasto::fastoremote::HttpServerHandlerHost* handler = NULL;
...
void sync_config()
{
    ...
    if (ini_parse(config_path, ini_handler, &config) < 0) {
