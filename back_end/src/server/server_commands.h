...
// http
#define SERVER_PLEASE_CONNECT_HTTP_COMMAND_REQ_1S GENERATE_FMT(SERVER_PLEASE_CONNECT_HTTP_COMMAND, "%s")
#define SERVER_PLEASE_CONNECT_HTTP_COMMAND_APPROVE_FAIL_1S GENEATATE_FAIL_FMT(SERVER_PLEASE_CONNECT_HTTP_COMMAND, "%s")
#define SERVER_PLEASE_CONNECT_HTTP_COMMAND_APPROVE_SUCCESS GENEATATE_SUCCESS_FMT(SERVER_PLEASE_CONNECT_HTTP_COMMAND, "")

// websocket
#define SERVER_PLEASE_CONNECT_WEBSOCKET_COMMAND_REQ_2SS GENERATE_FMT(SERVER_PLEASE_CONNECT_WEBSOCKET_COMMAND, "%s %s")
