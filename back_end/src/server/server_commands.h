...
// who are you
#define SERVER_WHO_ARE_YOU_COMMAND_REQ                                         \
  GENERATE_FMT(SERVER_WHO_ARE_YOU_COMMAND, "")
...
// system info
#define SERVER_PLEASE_SYSTEM_INFO_COMMAND_REQ                                  \
...
// for publish only
// id cmd
#define SERVER_COMMANDS_OUT_FAIL_2US(CAUSE)                                    \
  "%" PRIu64 " " FAIL_COMMAND " %s " CAUSE
